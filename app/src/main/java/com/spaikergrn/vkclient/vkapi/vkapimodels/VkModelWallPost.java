...
public class VkModelWallPost implements VkAttachments.VkModelAttachments {
    ...
    public VkModelWallPost(final JSONObject pObject) throws JSONException {
        parse(pObject);
    }

    public VkModelWallPost parse(final JSONObject pObject) throws JSONException {
        ...
        if (copyHistory != null) {
            for (int i = 0; i < copyHistory.length(); i++) {
                mCopyHistory.add(new VkModelWallPost(copyHistory.optJSONObject(i)));
            }
        }
        return this;
    }
    ...
    public List<VkModelWallPost> getCopyHistory() {
        return mCopyHistory;
    }

    public void setCopyHistory(final List<VkModelWallPost> pCopyHistory) {
